...
def set_pen(turtle_id, width):
    pen_service = rospy.ServiceProxy('/turtle' + str(turtle_id + 1) + '/set_pen', SetPen)
    pen_service(255, 255, 255, 2, width)
    ...
    while not rospy.is_shutdown():
        ...
        for i in range(3):
            ...
            if i != turtle_id:
                ...
                if distance < 1: # increase the distance threshold to avoid false collisions
